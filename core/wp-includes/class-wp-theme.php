...
final class WP_Theme implements ArrayAccess {
	 ...
	 *
	 * Default is false. Can be set with the {@see 'wp_cache_themes_persistently'} filters.
	 *
	 * @var bool
	 */
	 ...
	 * get_theme_root_uri() and allow it to run the {@see 'theme_root_uri'} filters.
	 *
	 * @since 3.4.0
	 *
	...
	public static function get_allowed_on_site( $blog_id = null ) {
		...
		/** This filters is documented in wp-includes/class-wp-theme.php */
		return (array) apply_filters( 'site_allowed_themes', $allowed_themes[ $blog_id ], $blog_id );
	}
