...
class WP_Site_Query {
	...
	public function get_sites() {
		 ...
		 * - Otherwise the filters should return an array of WP_Site objects.
		 *
		 * Note that if the filters returns an array of site data, it will be assigned
		 ...
		 * passed to the filters by reference. If WP_Site_Query does not perform a database
