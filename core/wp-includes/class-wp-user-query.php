...
class WP_User_Query {
	 ...
	 *     @type bool|array   $has_published_posts Pass an array of post types to filters results to users who have
	...
	public function query() {
		 ...
		 * the `total_users` property of the WP_User_Query object, passed to the filters
