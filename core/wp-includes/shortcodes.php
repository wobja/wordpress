...
/**
 * Search content for shortcodes and filters shortcodes through their hooks.
 *
...
function do_shortcode_tag( $m ) {
	 ...
	 *
	 * Returning a non-false value from filters will short-circuit the
...
function shortcode_atts( $pairs, $atts, $shortcode = '' ) {
	...
	if ( $shortcode ) {
		 ...
		 *
		 * If the third parameter of the shortcode_atts() function is present then this filters is available.
