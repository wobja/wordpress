 ...
 *
 * If the locale is set, then it will filters the locale in the {@see 'locale'}
 * filters hook and return the value.
 *
 * If the locale is not set already, then the WPLANG constant is used if it is
 * defined. Then it is filtered through the {@see 'locale'} filters hook and
...
function get_locale() {
	...
	if ( isset( $locale ) ) {
		/** This filters is documented in wp-includes/l10n.php */
...
function determine_locale() {
	 ...
	 *
	 * Using this filters allows to override the default logic, effectively short-circuiting the function.
	 *
	 * @since 5.0.0
	 *
 ...
 *
 * @since 2.2.0
 * @since 5.5.0 Introduced gettext-{$domain} filters.
 *
 ...
 *
 * @since 2.8.0
 * @since 5.5.0 Introduced gettext_with_context-{$domain} filters.
 *
 * @param string $text    Text to translate.
 ...
 *
 * @since 2.8.0
 * @since 5.5.0 Introduced ngettext-{$domain} filters.
 *
 ...
 *
 * @since 2.8.0
 * @since 5.5.0 Introduced ngettext_with_context-{$domain} filters.
 *
 * @param string $single  The text to be used if the number is singular.
 * @param string $plural  The text to be used if the number is plural.
 * @param int    $number  The number to compare against to use either the singular or plural form.
 ...
 *
 * @since 3.0.0
 * @since 4.7.0 The results are now filterable with the {@see 'get_available_languages'} filters.
 *
