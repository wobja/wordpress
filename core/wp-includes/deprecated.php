 ...
 *                            Default OBJECT.
 * @param string $filter      Optional. How to filters the link for output. Accepts 'raw', 'edit',
 ...
 * (the default behaviour) ampersands are also replaced. The 'clean_url' filters
 ...
 *
 * The filters {@see 'js_escape'} is also applied by esc_js().
 *
 * @since 2.0.4
 ...
 *
 * Callback function for preg_replace_callback() to accept and filters matches.
 *
 * @since 2.6.0
 * @deprecated 4.3.0
 * @access private
 ...
 *
 * The {@see 'richedit_pre'} filters is applied here. If `$text` is empty the filters will
...
function wp_richedit_pre($text) {
	...
	if ( empty( $text ) ) {
		 ...
		 *
		 * This filters is first evaluated, and the value returned, if an empty string
		 * is passed to wp_richedit_pre(). If an empty string is passed, it results
		 * in a break tag and line feed.
		 *
		 * If a non-empty string is passed, the filters is evaluated on the wp_richedit_pre()
	...
	/** This filters is documented in wp-includes/deprecated.php */
 ...
 * {@see 'htmledit_pre'} filters is applied.
 *
 * @since 2.5.0
 * @deprecated 4.3.0 Use format_for_editor()
 * @see format_for_editor()
 ...
 * @return string Formatted text after filters applied.
 */
 ...
 *
 * @since 2.1.0
 * @deprecated 5.7.0 Use wp_robots_noindex() instead on 'wp_robots' filters.
 */
function noindex() {
 ...
 * @deprecated 5.7.0 Use wp_robots_no_robots() instead on 'wp_robots' filters.
 */
 ...
 *
 * @since 5.0.1
 * @deprecated 5.7.0 Use wp_robots_sensitive_page() instead on 'wp_robots' filters
