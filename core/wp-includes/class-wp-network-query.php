...
class WP_Network_Query {
	...
	public function get_networks() {
		 ...
		 * - Otherwise the filters should return an array of WP_Network objects.
		 *
		 * Note that if the filters returns an array of network data, it will be assigned
		 ...
		 * passed to the filters by reference. If WP_Network_Query does not perform a database
