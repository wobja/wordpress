...
class WP_User {
	...
	/**
	 * The filters context applied to user data fields.
	 *
	 * @since 2.9.0
	 * @var string
	 */
	...
	public function has_cap( $cap, ...$args ) {
		...
		// Maintain BC for the argument passed to the "user_has_cap" filters.
		$args = array_merge( array( $cap, $this->ID ), $args );

		/**
		 * Dynamically filters a user's capabilities.
		 *
		 * @since 2.0.0
