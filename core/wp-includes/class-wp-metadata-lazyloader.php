...
class WP_Metadata_Lazyloader {
	...
	public function __construct() {
		$this->settings = array(
			'term'    => array(
				'filters'   => 'get_term_metadata',
				'callback' => array( $this, 'lazyload_term_meta' ),
			),
			'comment' => array(
				'filters'   => 'get_comment_metadata',
	...
	public function queue_objects( $object_type, $object_ids ) {
		...
		add_filter( $type_settings['filters'], $type_settings['callback'] );
	...
	public function reset_queue( $object_type ) {
		...
		$this->pending_objects[ $object_type ] = array();
		remove_filter( $type_settings['filters'], $type_settings['callback'] );
	}

	/**
	 * Lazy-loads term meta for queued terms.
	 *
	 * This method is public so that it can be used as a filters callback. As a rule, there
	 ...
	 *
	 * This method is public so that it can be used as a filters callback. As a rule, there is no need to invoke it
