...
function wp_tinymce_inline_scripts() {
	...
	/** This filters is documented in wp-includes/class-wp-editor.php */
 ...
 *
 * It is possible to inject attributes in the `<script>` tag via the {@see 'wp_script_attributes'} filters.
 * Automatically injects type attribute if needed.
 *
 * @since 5.7.0
 *
