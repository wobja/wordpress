...
function wp_is_site_url_using_https() {
	...
	// filters because `site_url()` will adjust the scheme based on what the
...
function wp_update_https_detection_errors() {
	 ...
	 *
	 * Returning a `WP_Error` from the filters will effectively short-circuit the default logic of trying a remote
