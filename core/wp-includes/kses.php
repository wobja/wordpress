<?php
/**
 * kses 0.2.2 - HTML/XHTML filters that only allows some elements and attributes
 ...
 * {@see 'wp_kses_allowed_html'} filters is more powerful and supplies context.
 *
 ...
 * @since 1.0.0
 *
 * @param string         $string            Text content to filters.
 ...
 *                              'strip', 'data', 'entities', or the name of a field filters such as
...
function wp_kses_allowed_html( $context = '' ) {
	...
	switch ( $context ) {
		case 'post':
			/** This filters is documented in wp-includes/kses.php */
			$tags = apply_filters( 'wp_kses_allowed_html', $allowedposttags, $context );

			// 5.0.1 removed the `<form>` tag, allow it if a filters is allowing it's sub-elements `<input>` or `<select>`.
 ...
 * @since 1.0.0
 *
 * @param string         $string            Content to filters through KSES.
 * @param array[]|string $allowed_html      An array of allowed HTML elements and attributes,
 *                                          or a context name such as 'post'. See wp_kses_allowed_html()
 *                                          for the list of accepted context names.
 * @param string[]       $allowed_protocols Array of allowed URL protocols.
 ...
 *
 * @param string         $string            Content to filters.
 * @param array[]|string $allowed_html      An array of allowed HTML elements and attributes,
 *                                          or a context name such as 'post'. See wp_kses_allowed_html()
 *                                          for the list of accepted context names.
 * @param string[]       $allowed_protocols Array of allowed URL protocols.
...
function wp_kses_uri_attributes() {
	 ...
	 *
	 * Use this filters to add any `data-` attributes that are required to be
	 * validated as a URL.
	 *
	 * @since 5.0.1
	 *
 ...
 * through another filters which will remove illegal attributes and once that is
 ...
 * @since 1.0.0
 *
 * @param string   $string            Content to filters bad protocols from.
 * @param string[] $allowed_protocols Array of allowed URL protocols.
 ...
 * @since 1.0.0
 *
 * @param string $string  Content to filters null characters from.
 ...
 * @since 1.0.0
 *
 * @param string $data Content to filters, expected to be escaped with slashes.
 * @return string Filtered content.
 */
 ...
 * @since 2.9.0
 *
 * @param string $data Content to filters, expected to not be escaped.
 * @return string Filtered content.
 */
 ...
 * @since 2.0.0
 *
 * @param string $data Post content to filters, expected to be escaped with slashes.
 ...
 * @since 2.9.0
 *
 * @param string $data Post content to filters.
 * @return string Filtered post content with allowed HTML tags and attributes intact.
 */
 ...
 * to have KSES filters the content. If the user does not have `unfiltered_html`
