...
class WP_Query {
	 ...
	 *                                                 the 'wp_query_search_exclusion_prefix' filters.
	...
	public function get_posts() {
		 ...
		 * passed to the filters by reference. If WP_Query does not perform a database
		...
		if ( ! empty( $this->posts ) && $this->is_comment_feed && $this->is_singular ) {
			/** This filters is documented in wp-includes/query.php */
