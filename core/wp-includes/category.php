 ...
 * filters and finally sanitized based on the $filters parameter value.
 *
 * @since 1.5.1
 *
 ...
 * @param int    $cat_id  Category ID.
 * @param string $context What filters to use, 'raw', 'display', etc.
 ...
 * and finally sanitized based on the $filters parameter value.
 *
 * @since 2.3.0
 *
