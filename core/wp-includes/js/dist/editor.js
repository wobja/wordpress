...
Object(external_wp_hooks_["addFilter"])('blocks.registerBlockType', 'core/editor/custom-sources-backwards-compatibility/shim-attribute-source', shimAttributeSource); // The above filters will only capture blocks registered after the filters was
...
class hierarchical_term_selector_HierarchicalTermSelector extends external_wp_element_["Component"] {
  ...
  getFilterMatcher(filterValue) {
    const matchTermsForFilter = originalTerm => {
      ...
      }; // Map and filters the children, recursive so we deal with grandchildren
  ...
  render() {
    ...
    return [showFilter && Object(external_wp_element_["createElement"])("label", {
      ...
      className: "editor-post-taxonomies__hierarchical-terms-filters",
      key: "term-filters-input"
    }), Object(external_wp_element_["createElement"])("div", {
