 ...
 * be used to filters out content.
 *
...
/**
 * Adjusts the start and end offsets from a range based on a text filters.
 *
 * @param {Node}     node   Node of which the text should be filtered.
 * @param {Range}    range  The range to filters.
 * @param {Function} filter Function to use to filters the text.
 *
 ...
 * @param {Function}      [$1.prepareEditableTree] Function to filters editorable formats.
