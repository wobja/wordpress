...
AttachmentFilters = wp.media.View.extend(/** @lends wp.media.view.AttachmentFilters.prototype */{
	...
	/**
	 * When the selected filters changes, update the Attachment Query properties to match.
	 */
	change: function() {
 ...
 *                                                 browser's toolbar.
 * @param {boolean}        [options.date=true]     Whether to show the date filters in the
 *                                                 browser's toolbar.
...
AttachmentsBrowser = View.extend(/** @lends wp.media.view.AttachmentsBrowser.prototype */{
	...
	createToolbar: function() {
		...
		if ( this.controller.isModeActive( 'grid' ) ) {
			toolbarOptions.className = 'media-toolbar wp-filters';
		}
		...
		*/
		...
		if ( showFilterByType || this.options.date ) {
			/*
			 * Create a h2 heading before the select elements that filters attachments.
			...
			this.toolbar.set( 'filters-heading', new wp.media.view.Heading( {
				...
				level:      'h2',
				className:  'media-attachments-filters-heading'
			}).render() );
		}
 ...
 * @param {boolean}                    [attributes.date=true]             Whether to show the date filters in the browser's toolbar.
 ...
 *
 * A view to display fields added via the `attachment_fields_to_edit` filters.
 *
 * @memberOf wp.media.view
 *
 * @class
...
/**
 * A filters dropdown for month/dates.
 *
 * @memberOf wp.media.view.AttachmentFilters
 *
 * @class
