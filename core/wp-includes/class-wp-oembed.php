...
class WP_oEmbed {
	 ...
	 *
	 * The just-in-time addition is for the benefit of the {@see 'oembed_providers'} filters.
	 *
	 * @since 4.0.0
	 *
	 * @see wp_oembed_add_provider()
	 ...
	 * the {@see 'plugins_loaded'} hook.
	 *
	 * The just-in-time removal is for the benefit of the {@see 'oembed_providers'} filters.
	 *
	 * @since 4.0.0
	 *
	...
	public function get_html( $url, $args = '' ) {
		 ...
		 *
		 * Returning a non-null value from the filters will effectively short-circuit retrieval
	...
	private function _fetch_with_format( $provider_url_with_args, $format ) {
		...
		/** This filters is documented in wp-includes/class-wp-oembed.php */
	...
	public function data2html( $data, $url ) {
		 ...
		 *
		 * Use this filters to add support for custom data types, or to filters the result.
		 *
		 * @since 2.9.0
		 *
