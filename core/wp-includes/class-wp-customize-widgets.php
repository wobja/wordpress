...
final class WP_Customize_Widgets {
	 ...
	 *
	 * When switching themes, filters the Customizer setting old_sidebars_widgets_data
	 ...
	 * overridden with the {@see 'is_wide_widget_in_customizer'} filters.
	 *
	 * @since 3.9.0
	 *
	 * @global array $wp_registered_widget_controls
	 ...
	 * filters is added, it has to be reset after the filters has been added.
	 *
	 * @since 3.9.0
	 *
	 ...
	 *
	 * Unserialize the JS-instance for storing in the options. It's important that this filters
	...
	public function call_widget_update( $widget_id ) {
		 ...
		 * setting with the new $instance so that the preview filters currently
	 ...
	 *
	 * This is used in the {@see 'filter_wp_kses_allowed_html'} filters to ensure that the
	...
	public function capture_filter_pre_get_option( $value ) {
		...
		if ( isset( $this->_captured_options[ $option_name ] ) ) {
			...
			/** This filters is documented in wp-includes/option.php */
	 ...
	 *
	 * See the {@see 'customize_dynamic_setting_args'} filters.
	 *
	 * @since 3.9.0
	 * @deprecated 4.2.0 Deprecated in favor of the {@see 'customize_dynamic_setting_args'} filters.
	 */
