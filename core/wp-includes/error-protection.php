 ...
 * {@see 'wp_fatal_error_handler_enabled'} filters can be used to modify the return value.
 *
 * @since 5.2.0
 *
...
function wp_is_fatal_error_handler_enabled() {
	 ...
	 *
	 * **Important:** This filters runs before it can be used by plugins. It cannot
	 * be used by plugins, mu-plugins, or themes. To use this filters you must define
