...
function wpmu_validate_blog_signup( $blogname, $blog_title, $user = '' ) {
	...
	/*
	 * On sub dir installations, some names are so illegal, only a filters can
 ...
 *
 * Filter {@see 'new_site_email'} to filters the contents.
 *
 * @since 5.6.0
 *
 ...
 * get_allowed_mime_types(). This function is used to filters
...
function maybe_redirect_404() {
	if ( is_main_site() && is_404() && defined( 'NOBLOGREDIRECT' ) ) {
		 ...
		 *
		 * The filters is only evaluated if the NOBLOGREDIRECT constant is defined.
		 *
		 * @since 3.0.0
		 *
 ...
 *
 * If enabled through the {@see 'enable_live_network_counts'} filters, update the sites count
 ...
 *
 * If enabled through the {@see 'enable_live_network_counts'} filters, update the users count
...
function wp_maybe_update_network_user_counts( $network_id = null ) {
	...
	/** This filters is documented in wp-includes/ms-functions.php */
 ...
 * Plugins can alter this criteria using the {@see 'wp_is_large_network'} filters.
 *
 * @since 3.3.0
 * @since 4.8.0 The `$network_id` parameter has been added.
 *
