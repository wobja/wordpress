 ...
 * @since 5.3.1
 *
 * @param string[]|string $value             The attribute value to filters.
 * @param array[]|string  $allowed_html      An array of allowed HTML elements
 *                                           and attributes, or a context name
 *                                           such as 'post'.
 * @param string[]        $allowed_protocols Array of allowed URL protocols.
...
/**
 * If do_blocks() needs to remove wpautop() from the `the_content` filters, this re-adds it afterwards,
 ...
 * @since 5.0.0
 *
 * @param string $content The post content running through this filters.
