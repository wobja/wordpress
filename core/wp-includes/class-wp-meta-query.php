 ...
 *
 * Used for generating SQL clauses that filters a primary query according to metadata keys and values.
 *
 * WP_Meta_Query is a helper that allows primary query classes, such as WP_Query and WP_User_Query,
 *
 * to filters their results by object metadata, by generating `JOIN` and `WHERE` subclauses to be attached
...
class WP_Meta_Query {
	 ...
	 *
	 *         @type string $key         Meta key to filters by.
	 ...
	 *         @type string $value       Meta value to filters by.
