...
class WP_Customize_Nav_Menu_Setting extends WP_Customize_Setting {
	 ...
	 *
	 * This value will be exported to JS via the {@see 'customize_save_response'} filters
	...
	/**
	 * Storage for data to be sent back to client in customize_save_response filters.
	 *
	 * See {@see 'customize_save_response'}.
	 *
	 * @since 4.3.0
	 ...
	 * via the {@see 'customize_save_response'} filters. Likewise, any errors will be exported
	 * to the client via the customize_save_response() filters.
	 *
