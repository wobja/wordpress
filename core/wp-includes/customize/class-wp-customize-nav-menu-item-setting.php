...
class WP_Customize_Nav_Menu_Item_Setting extends WP_Customize_Setting {
	 ...
	 *
	 * This value will be exported to JS via the customize_save_response filters
	...
	/**
	 * Status for calling the update method, used in customize_save_response filters.
	 *
	...
	public function value_as_wp_post_nav_menu_item() {
		...
		/** This filters is documented in wp-includes/nav-menu.php */
	 ...
	 * via the {@see 'customize_save_response'} filters. Likewise, any errors will be
	 * exported to the client via the customize_save_response() filters.
	 *
