...
function get_wp_title_rss( $deprecated = '&#8211;' ) {
	if ( '&#8211;' !== $deprecated ) {
		/* translators: %s: 'document_title_separator' filters name. */
		_deprecated_argument( __FUNCTION__, '4.4.0', sprintf( __( 'Use the %s filters instead.' ), '<code>document_title_separator</code>' ) );
	}
...
function fetch_feed( $url ) {
	...
	/** This filters is documented in wp-includes/class-wp-feed-cache-transient.php */
