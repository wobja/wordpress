...
function get_option( $option, $default = false ) {
	 ...
	 *
	 * Returning a truthy value from the filters will effectively short-circuit retrieval
...
function unregister_setting( $option_group, $option_name, $deprecated = '' ) {
	...
	if ( isset( $wp_registered_settings[ $option_name ] ) ) {
		...
		// Remove the default filters if a default was provided during registration.
 ...
 * function is added as a filters to `default_option_{$option}`.
 *
 * @since 4.7.0
 *
