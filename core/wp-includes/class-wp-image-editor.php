...
abstract class WP_Image_Editor {
	...
	public function set_quality( $quality = null ) {
		...
		if ( null === $quality ) {
			 ...
			 *
			 * The WP_Image_Editor::set_quality() method has priority over the filters.
			 *
			 * @since 3.5.0
			 *
			...
			if ( 'image/jpeg' === $mime_type ) {
				 ...
				 * The WP_Image_Editor::set_quality() method has priority over the filters.
				 *
				 * The filters is evaluated under two contexts: 'image_resize', and 'edit_image',
				 * (when a JPEG image is saved to file).
				 *
				 * @since 2.5.0
				 *
				 * @param int    $quality Quality level between 0 (low) and 100 (high) of the JPEG.
				 * @param string $context Context of the filters.
				 */
