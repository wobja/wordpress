...
class WP_REST_Posts_Controller extends WP_REST_Controller {
	...
	public function get_items( $request ) {
		...
		// Ensure our per_page parameter overrides any provided posts_per_page filters.
	...
	public function get_item_schema() {
		 ...
		 *
		 * The dynamic portion of the filters, `$this->post_type`, refers to the
		...
		// Emit a _doing_it_wrong warning if user tries to add new properties using this filters.
	...
	public function get_collection_params() {
		 ...
		 *
		 * The dynamic part of the filters `$this->post_type` refers to the post
		 * type slug for the controller.
		 *
		 * This filters registers the collection parameter, but does not map the
		 * collection parameter to an internal WP_Query parameter. Use the
		 * `rest_{$this->post_type}_query` filters to set WP_Query parameters.
		 *
		 * @since 4.7.0
		 *
