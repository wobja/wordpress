...
if ( ! function_exists( 'wp_mail' ) ) :
	 ...
	 * {@see 'wp_mail_content_type'} filters.
	 *
	 * The default charset is based on the charset used on the blog. The charset can
	 * be set using the {@see 'wp_mail_charset'} filters.
	 *
	 * @since 1.2.1
...
if ( ! function_exists( 'wp_notify_postauthor' ) ) :
	...
	function wp_notify_postauthor( $comment_id, $deprecated = null ) {
		 ...
		 *
		 * By default, only post authors are notified of comments. This filters allows
		 * others to be added.
		 *
		 * @since 3.7.0
		 *
		 ...
		 * posts. This filters allows you to override that.
		 *
		 * @since 3.8.0
		 *
...
if ( ! function_exists( 'wp_notify_moderator' ) ) :
	 ...
	 * @global wpdb $wpdb WordPress database abstraction object.
	 *
	 * Uses the {@see 'notify_moderator'} filters to determine whether the site moderator
...
if ( ! function_exists( 'get_avatar' ) ) :
	...
	function get_avatar( $id_or_email, $size = 96, $default = '', $alt = '', $args = null ) {
		 ...
		 * the value through the {@see 'get_avatar'} filters and returning early.
		 *
		 * @since 4.2.0
		 *
