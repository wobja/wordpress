...
final class WP_Site {
	...
	public function __get( $key ) {
		switch ( $key ) {
			...
			case 'post_count':
			case 'home':
			default: // Custom properties added by 'site_details' filters.
	...
	private function get_details() {
		...
		if ( false === $details ) {
			...
			// Create a raw copy of the object for backward compatibility with the filters below.
		...
		/** This filters is documented in wp-includes/ms-blogs.php */
