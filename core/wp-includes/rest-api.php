...
function get_rest_url( $blog_id = null, $path = '/', $scheme = 'rest' ) {
	 ...
	 *
	 * Use this filters to adjust the url returned by the get_rest_url() function.
	 *
	 * @since 4.4.0
	 *
...
function rest_get_server() {
	...
	if ( empty( $wp_rest_server ) ) {
		 ...
		 *
		 * This filters allows you to adjust the server class used by the REST API, using a
...
function rest_get_avatar_sizes() {
	 ...
	 *
	 * Use this filters to adjust the array of sizes returned by the
 ...
 * @param array        $schema  The schema for the endpoint used to filters the response.
