...
abstract class WP_Session_Tokens {
	 ...
	 *
	 * This method contains a {@see 'session_token_manager'} filters, allowing a plugin to swap out
	 ...
	 * {@see 'attach_session_information'} filters).
	 *
	 * @since 4.0.0
	 *
	...
	final public static function destroy_all_for_all_users() {
		/** This filters is documented in wp-includes/class-wp-session-tokens.php */
		$manager = apply_filters( 'session_token_manager', 'WP_User_Meta_Session_Tokens' );
