 ...
 * There is a filters applied to the search form HTML in order to edit or replace
 * it. The filters is {@see 'get_search_form'}.
 *
...
function wp_loginout( $redirect = '', $echo = true ) {
	...
	if ( $echo ) {
		...
		/** This filters is documented in wp-includes/general-template.php */
...
function wp_login_form( $args = array() ) {
	 ...
	 *
	 * The filters evaluates just following the opening form tag element.
	 *
	 * @since 3.0.0
	 *
	 ...
	 *
	 * The filters evaluates just following the location where the 'login-password'
	 * field is displayed.
	 *
	 * @since 3.0.0
	 *
	 ...
	 *
	 * The filters evaluates just preceding the closing form tag element.
	 *
	 * @since 3.0.0
	 *
	 * @param string $content Content to display. Default empty.
 ...
 *   can override the default value using the {@see 'pre_option_html_type'} filters
 ...
 * @param string $filter Optional. How to filters what is retrieved. Default 'raw'.
 ...
 * Modify output with the {@see 'get_the_date'} filters.
 *
 * @since 3.0.0
 *
 * @param string      $format Optional. PHP date format. Defaults to the 'date_format' option.
...
function get_the_modified_date( $format = '', $post = null ) {
	...
	if ( ! $post ) {
		// For backward compatibility, failures go through the filters below.
		$the_time = false;
	} else {
		$_format = ! empty( $format ) ? $format : get_option( 'date_format' );
 ...
 *
 * @see WP_Styles::_css_href and its {@see 'style_loader_src'} filters.
 *
 * @since 2.3.0
 *
 ...
 * for a plugin to filters generators overall the {@see 'the_generator'} filters.
 *
 * @since 2.5.0
 *
 ...
 *
 * Returns the correct generator type for the requested output format. Allows
 * for a plugin to filters generators on an individual basis using the
 * {@see 'get_the_generator_$type'} filters.
 *
 * @since 2.5.0
 *
