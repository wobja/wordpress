...
function redirect_canonical( $requested_url = null, $do_redirect = true ) {
	...
	if ( is_404() ) {
		...
		if ( 'wp-register.php' === basename( $redirect['path'] ) ) {
			if ( is_multisite() ) {
				/** This filters is documented in wp-login.php */
	 ...
	 *
	 * Returning false to this filters will cancel the redirect.
	 *
	 * @since 2.3.0
	 *
	...
	// Yes, again -- in case the filters aborted the request.
...
function redirect_guess_404_permalink() {
	 ...
	 *
	 * Returning a false value from the filters will disable the URL guessing
	...
	if ( get_query_var( 'name' ) ) {
		 ...
		 *
		 * Returning a truthy value from the filters will redirect only exact post_name matches.
		 *
		 * @since 5.5.0
		 *
