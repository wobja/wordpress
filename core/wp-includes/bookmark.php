...
function get_bookmarks( $args = '' ) {
	...
	if ( ! empty( $parsed_args['category_name'] ) ) {
		...
		if ( $parsed_args['category'] ) {
			...
			/** This filters is documented in wp-includes/bookmark.php */
 ...
 * @param string         $context  Optional. How to filters the fields. Default 'display'.
 ...
 * filtering is applied. After the more strict filters is applied, if the `$context`
 * is 'raw' then the value is immediately return.
 *
 * Hooks exist for the more generic cases. With the 'edit' context, the {@see 'edit_$field'}
 * filters will be called and passed the `$value` and `$bookmark_id` respectively.
 *
 * With the 'db' context, the {@see 'pre_$field'} filters is called and passed the value.
 * The 'display' context is the final context and has the `$field` has the filters name
 ...
 * @param string $context     How to filters the field value. Accepts 'raw', 'edit', 'db',
...
function sanitize_bookmark_field( $field, $value, $bookmark_id, $context ) {
	...
	switch ( $field ) {
		case 'link_category': // array( ints )
			...
			// The 'link_category' filters is for the name of a link category, not an array of a link's link categories.
			return $value;
