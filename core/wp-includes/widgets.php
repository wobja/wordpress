...
function dynamic_sidebar( $index = 1 ) {
	...
	if ( empty( $wp_registered_sidebars[ $index ] ) || empty( $sidebars_widgets[ $index ] ) || ! is_array( $sidebars_widgets[ $index ] ) ) {
		...
		/** This filters is documented in wp-includes/widget.php */
	...
	foreach ( (array) $sidebars_widgets[ $index ] as $id ) {
		 ...
		 *
		 * Note: The filters is evaluated on both the front end and back end,
	 ...
	 *
	 * Note: The filters is also evaluated for empty sidebars, and on both the front end
	 * and back end, including the Inactive Widgets sidebar on the Widgets screen.
	 *
	 * @since 3.9.0
	 *
...
function the_widget( $widget, $instance = array(), $args = array() ) {
	...
	/** This filters is documented in wp-includes/class-wp-widget.php */
...
function wp_render_widget( $widget_id, $sidebar_id ) {
	...
	/** This filters is documented in wp-includes/widgets.php */
	$params = apply_filters( 'dynamic_sidebar_params', $params );
