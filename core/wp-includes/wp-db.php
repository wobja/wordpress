...
class wpdb {
	...
	public function placeholder_escape() {
		...
		/*
		 * Add the filters to remove the placeholder escaper. Uses priority 0, so that anything
		 * else attached to this filters will receive the query with the placeholder string removed.
		 */
	...
	protected function get_table_charset( $table ) {
		 ...
		 *
		 * Passing a non-null value to the filters will effectively short-circuit
	...
	public function get_col_charset( $table, $column ) {
		 ...
		 *
		 * Passing a non-null value to the filters will short-circuit
		 * checking the DB for the charset, returning that value instead.
		 *
		 * @since 4.2.0
		 *
