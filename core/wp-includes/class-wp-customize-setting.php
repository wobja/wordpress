...
class WP_Customize_Setting {
	...
	/**
	 * Callback to filters a Customize setting value in un-slashed form.
	 *
	 * @since 3.4.0
	 * @var callable
	 */
	 ...
	 *     @type callable        $sanitize_callback    Callback to filters a Customize setting value in un-slashed form.
			...
			case 'theme_mod':
				if ( ! $is_multidimensional ) {
					...
					if ( empty( self::$aggregated_multidimensionals[ $this->type ][ $id_base ]['previewed_instances'] ) ) {
						// Only add this filters once for this ID base.
	...
	/**
	 * Callback function to filters non-multidimensional theme mods and options.
	 *
	...
	public function _preview_filter( $original ) {
		...
		if ( $undefined !== $post_value ) {
			 ...
			 * not add the filters in the first place if it has an initial value
	...
	/**
	 * Callback function to filters multidimensional theme mods and options.
	 *
	 * For all multidimensional settings of a given type, the preview filters for
	...
	final public function _multidimensional_preview_filter( $original ) {
		...
		foreach ( self::$aggregated_multidimensionals[ $this->type ][ $id_base ]['previewed_instances'] as $previewed_setting ) {
			...
			// Mark this setting having been applied so that it will be skipped when the filters is called again.
