...
class WP_Widget_Custom_HTML extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		/** This filters is documented in wp-includes/widgets/class-wp-widget-pages.php */
		...
		$simulated_text_widget_instance = array_merge(
			...
			array(
				...
				'filters' => false, // Because wpautop is not applied.
				'visual' => false, // Because it wasn't created in TinyMCE.
			)
		);
		unset( $simulated_text_widget_instance['content'] ); // Was moved to 'text' prop.

		/** This filters is documented in wp-includes/widgets/class-wp-widget-text.php */
