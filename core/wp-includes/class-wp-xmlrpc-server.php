 ...
 * via the {@see 'xmlrpc_enabled'} filters found in wp_xmlrpc_server::set_is_enabled().
 *
 * @since 1.5.0
 *
 * @see IXR_Server
...
class wp_xmlrpc_server extends IXR_Server {
	 ...
	 * methods through the {@see 'xmlrpc_methods'} filters to allow plugins to extend
	...
	public function __construct() {
		 ...
		 *
		 * This filters can be used to add new methods, and remove built-in methods.
		 *
		 * @since 1.5.0
		 *
	...
	private function set_is_enabled() {
		 ...
		 *
		 * Contrary to the way it's named, this filters does not control whether XML-RPC is *fully*
		 ...
		 *
		 * Further, the filters does not control whether pingbacks or other custom endpoints that don't
		 * require authentication are enabled. This behavior is expected, and due to how parity was matched
		 * with the `enable_xmlrpc` UI option the filters replaced when it was introduced in 3.5.
		 *
	 ...
	 *
	 * Passes property through {@see 'xmlrpc_blog_options'} filters.
	 *
	 * @since 2.6.0
	 */
	 ...
	 * @see get_posts() for more on `$filters` values
	 *
	 * @param array $args {
	 *     Method arguments. Note: arguments must be ordered as documented.
	 *
	 ...
	 *     @type string $username Username.
	 *     @type string $password Password.
	 *     @type array  $filters   Optional. Modifies the query used to retrieve posts. Accepts 'post_type',
	 ...
	 * @since 3.4.0
	 *
	 * The optional $filters parameter modifies the query used to retrieve terms.
	 ...
	 *     @type string $password Password.
	 *     @type string $taxnomy  Taxonomy name.
	 *     @type array  $filters   Optional. Modifies the query used to retrieve posts. Accepts 'number',
	 ...
	 * Retrieve users.
	 *
	 * The optional $filters parameter modifies the query used to retrieve users.
	 ...
	 * Retrieve comments.
	 *
	 * Besides the common blog_id (unused), username, and password arguments, it takes a filters
	 * array as last argument.
	 *
	 * Accepted 'filters' keys are 'status', 'post_id', 'offset', and 'number'.
	 *
	...
	public function wp_newComment( $args ) {
		...
		/** This filters is documented in wp-includes/comment.php */
	 ...
	 * array as last argument.
	 *
	 * Accepted 'filters' keys are 'parent_id', 'mime_type', 'offset', and 'number'.
	 *
	 * The defaults are as follows:
	...
	public function pingback_ping( $args ) {
		...
		/** This filters is documented in wp-includes/class-http.php */
