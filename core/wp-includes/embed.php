 ...
 *
 * The {@see 'embed_defaults'} filters can be used to adjust either of these values.
 *
 * @since 2.9.0
 *
...
function get_oembed_response_data_for_url( $url, $args ) {
	...
	/** This filters is documented in wp-includes/class-wp-oembed-controller.php */
 ...
 * we need to filters the HTML heavily for security.
 *
 ...
 * @access private
 *
 * @param string $content The content to filters.
