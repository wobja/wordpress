...
class WP {
	 ...
	 *
	 * The {@see 'query_string'} filters is deprecated, but still works. Plugins should
	 * use the {@see 'request'} filters instead.
	 *
	 * @since 2.0.0
	 */
	...
	public function handle_404() {
		 ...
		 *
		 * Returning a non-false value from the filters will short-circuit the handling
		 * and return early.
		 *
		 * @since 4.5.0
		 *
