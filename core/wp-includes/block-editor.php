...
function get_block_categories( $post_or_block_editor_context ) {
	...
	if ( ! empty( $block_editor_context->post ) ) {
		 ...
		 *
		 * @since 5.0.0
		 * @deprecated 5.8.0 Use the {@see 'block_categories_all'} filters instead.
		 *
		 * @param array[] $block_categories Array of categories for block types.
...
function get_allowed_block_types( $block_editor_context ) {
	...
	if ( ! empty( $block_editor_context->post ) ) {
		 ...
		 *
		 * @since 5.0.0
		 * @deprecated 5.8.0 Use the {@see 'allowed_block_types_all'} filters instead.
		 *
		 * @param bool|array $allowed_block_types Array of block type slugs, or boolean to enable/disable all.
		 *                                        Default true (all registered block types supported)
...
function get_block_editor_settings( array $custom_settings, $block_editor_context ) {
	...
	if ( ! empty( $block_editor_context->post ) ) {
		 ...
		 *
		 * @since 5.0.0
		 * @deprecated 5.8.0 Use the {@see 'block_editor_settings_all'} filters instead.
		 *
		 * @param array   $editor_settings Default editor settings.
...
function block_editor_rest_api_preload( array $preload_paths, $block_editor_context ) {
	...
	if ( ! empty( $block_editor_context->post ) ) {
		 ...
		 *
		 * @since 5.0.0
		 * @deprecated 5.8.0 Use the {@see 'block_editor_rest_api_preload_paths'} filters instead.
		 *
		 * @param string[] $preload_paths Array of paths to preload.
