...
function wp_is_maintenance_mode() {
	 ...
	 *
	 * This filters runs before it can be used by plugins. It is designed for
	 * non-web runtimes. If this filters returns true, maintenance mode will be
...
function wp_debug_mode() {
	 ...
	 *
	 * To use this filters you must define a `$wp_filter` global before
...
function wp_start_object_cache() {
	 ...
	 *
	 * This filters runs before it can be used by plugins. It is designed for non-web
...
function is_protected_endpoint() {
	 ...
	 *
	 * This filters is only fired when an endpoint is requested which is not already protected by
...
function is_protected_ajax_action() {
	 ...
	 *
	 * This filters is only fired when doing Ajax and the Ajax request has an 'action' property.
	 *
	 * @since 5.2.0
	 *
...
function wp_is_jsonp_request() {
	...
	/** This filters is documented in wp-includes/rest-api/class-wp-rest-server.php */
