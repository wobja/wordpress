...
function get_the_title( $post = 0 ) {
	...
	if ( ! is_admin() ) {
		if ( ! empty( $post->post_password ) ) {
			 ...
			 *
			 * The filters is only applied on the front end.
			 *
			 * @since 2.8.0
			 *
 ...
 * passed through the filters, {@see 'post_class'}, with the list of class names, followed by
...
function wp_list_pages( $args = '' ) {
	...
	// Allow plugins to filters an array of excluded pages (but don't put a nullstring into the array).
