...
function render_block_core_post_excerpt( $attributes, $content, $block ) {
	...
	/**
	 * Some themes might use `excerpt_more` filters to handle the
	 * `more` link displayed after a trimmed excerpt. Since the
	 * block has a `more text` attribute we have to check and
	 * override if needed the return value from this filters.
	 * So if the block's attribute is not empty override the
	 * `excerpt_more` filters and return nothing. This will
