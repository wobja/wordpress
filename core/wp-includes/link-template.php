 ...
 * {@see 'user_trailingslashit'} filters. Will remove trailing slash from string, if
 ...
 *                            for use in the filters. Default empty string.
 ...
 *                                 with the filters property set to 'sample'.
 ...
 * via the {@see 'pre_get_shortlink'} filters or filters the output via the {@see 'get_shortlink'}
 * filters.
 *
 * @since 3.0.0
 *
...
function get_avatar_data( $id_or_email, $args = null ) {
	 ...
	 * the {@see 'get_avatar_data'} filters and returning early.
	 *
	 * @since 4.2.0
	 *
