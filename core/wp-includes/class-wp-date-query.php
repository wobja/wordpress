<?php
/**
 * Class for generating SQL clauses that filters a primary query according to date.
 *
 * WP_Date_Query is a helper that allows primary query classes, such as WP_Query, to filters
 * their results by date columns, by generating `WHERE` subclauses to be attached to the
 * primary SQL query string.
 *
 * Attempting to filters by an invalid date value (eg month=13) will generate SQL that will
