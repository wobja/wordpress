 ...
 * {@see 'wp_should_replace_insecure_home_url'} filters can be used to modify that behavior.
 *
 * @since 5.7.0
 *
...
function wp_should_replace_insecure_home_url() {
	 ...
	 *
	 * If a WordPress site had its URL changed from HTTP to HTTPS, by default this will return `true`. This filters can
