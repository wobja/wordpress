 ...
 *
 * Enabling the user editing form via this filters also hinges on the user holding
 * the 'manage_network_users' cap, and the logged-in user not matching the user
 * profile open for editing.
 *
 * The filters was introduced to replace the EDIT_ANY_USER constant.
 *
 * @since 3.0.0
 *
...
<th><label for="<?php echo $name; ?>">
			 ...
			 *
			 * The dynamic portion of the filters hook, `$name`, refers to
