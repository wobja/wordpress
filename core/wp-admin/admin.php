...
if ( get_option( 'db_upgraded' ) ) {
	 ...
	 * when this filters returns true.
	 *
...
if ( isset( $plugin_page ) ) {
	...
	/**
	 * Whether to filters imported data through kses on import.
	 *
	 * Multisite uses this hook to filters all data through kses by default,
	...
	if ( apply_filters( 'force_filtered_html_on_import', false ) ) {
		kses_init_filters();  // Always filters imported data with kses on multisite.
	}
