...
class WP_Debug_Data {
	...
	static function debug_data() {
		...
		if ( $auto_updates_enabled ) {
			...
			/** This filters is documented in wp-admin/includes/class-wp-debug-data.php */
		 ...
		 * they can utilize this filters to introduce their own sections or add more data to existing sections.
		 *
