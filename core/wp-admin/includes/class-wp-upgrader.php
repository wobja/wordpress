...
class WP_Upgrader {
	 ...
	 * {@see 'upgrader_post_install'} filters. In that case, the WP_Error will be assigned to
	 * it.
	 *
	 * @since 2.8.0
	 *
	 ...
	 * @param array  $hook_extra       Extra arguments to pass to the filters hooks. Default empty array.
	 ...
	 *     @type array  $hook_extra                  Extra arguments to pass to the filters hooks called by
