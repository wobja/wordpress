 ...
 *
 * The first filters, {@see 'plugins_api_args'}, is for the args and gives the action
 * as the second parameter. The hook for {@see 'plugins_api_args'} must ensure that
 * an object is returned.
 *
 * The second filters, {@see 'plugins_api'}, allows a plugin to override the WordPress.org
 ...
 * be passed.
 *
 * Finally, the third filters, {@see 'plugins_api_result'}, makes it possible to filters the
 ...
 *     @type string  $tag               Tag to filters plugins. Default empty.
 *     @type string  $author            Username of an plugin author to filters plugins. Default empty.
				...
				<div class="counter-container">
						<span class="counter-label">
							...
							printf(
								...
								"https://wordpress.org/support/plugin/{$api->slug}/reviews/?filters={$key}",
								$aria_label,
