 ...
 *
 * See the {@see 'menu_order'} filters for reordering menu items.
 *
 * @since 2.8.0
 *
...
if ( apply_filters( 'custom_menu_order', false ) ) {
	 ...
	 *
	 * A truthy value must first be passed to the {@see 'custom_menu_order'} filters
	 * for this filters to work. Use the following to enable custom menu ordering:
	 *
