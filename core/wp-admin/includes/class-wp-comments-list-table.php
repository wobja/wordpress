...
class WP_Comments_List_Table extends WP_List_Table {
	...
	protected function comment_type_dropdown( $comment_type ) {
		...
		if ( $comment_types && is_array( $comment_types ) ) {
			printf( '<label class="screen-reader-text" for="filters-by-comment-type">%s</label>', __( 'Filter by comment type' ) );

			echo '<select id="filters-by-comment-type" name="comment_type">';
...
<table class="wp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
	...
	protected function handle_row_actions( $comment, $column_name, $primary ) {
		...
		/** This filters is documented in wp-admin/includes/dashboard.php */
	...
	public function column_comment( $comment ) {
		...
		if ( $this->user_can ) {
			/** This filters is documented in wp-admin/includes/comment.php */
