...
<p class="search-box">
	...
	protected function view_switcher( $current_mode ) {
		...
		foreach ( $this->modes as $mode => $title ) {
			...
			printf(
				...
				esc_url( remove_query_arg( 'attachment-filters', add_query_arg( 'mode', $mode ) ) ),
				implode( ' ', $classes ),
				$title
			);
		}
	...
	protected function get_items_per_page( $option, $default = 20 ) {
		 ...
		 * on the type of list table in use. Possible filters names include:
		 *
	...
	/**
	 * Gets a list of all, hidden, and sortable columns, with filters applied.
	 *
	 * @since 3.1.0
	 *
	 * @return array
