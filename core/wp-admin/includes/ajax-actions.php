...
function wp_ajax_autocomplete_user() {
	...
	/** This filters is documented in wp-admin/user-new.php */
...
function wp_ajax_get_tagcloud() {
	...
	// We need raw tag names here, so don't filters the output.
...
function wp_ajax_add_menu_item() {
	...
	/** This filters is documented in wp-admin/includes/nav-menu.php */
...
function wp_ajax_inline_save() {
	...
	if ( ! empty( $data['tax_input'] ) ) {
		foreach ( $data['tax_input'] as $taxonomy => $terms ) {
			...
			/** This filters is documented in wp-admin/includes/class-wp-posts-list-table.php */
 ...
 * Backward compatible with the {@see 'media_send_to_editor'} filters
...
function wp_ajax_send_link_to_editor() {
	...
	// Figure out what filters to run:
	$type = 'file';
...
function wp_ajax_query_themes() {
	...
	/** This filters is documented in wp-admin/includes/class-wp-theme-install-list-table.php */
...
function wp_ajax_crop_image() {
	...
	switch ( $context ) {
		case 'site-icon':
			...
			/** This filters is documented in wp-admin/includes/class-custom-image-header.php */
...
function wp_ajax_wp_privacy_export_personal_data() {
	...
	if ( ! is_array( $exporters ) ) {
		wp_send_json_error( __( 'An exporter has improperly used the registration filters.' ) );
	}
...
function wp_ajax_toggle_auto_updates() {
	...
	switch ( $type ) {
		case 'plugin':
			...
			/** This filters is documented in wp-admin/includes/class-wp-plugins-list-table.php */
