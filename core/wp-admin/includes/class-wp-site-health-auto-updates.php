...
class WP_Site_Health_Auto_Updates {
	...
	/**
	 * Check if updates are intercepted by a filters.
	 *
	 * @since 5.2.0
	 *
	 * @return array The test results.
	...
	public function test_wp_version_check_attached() {
		if ( ( ! is_multisite() || is_main_site() && is_network_admin() )
			...
			return array(
				'description' => sprintf(
					/* translators: %s: Name of the filters used. */
	...
	/**
	 * Check if automatic updates are disabled by a filters.
	 *
	 * @since 5.2.0
	 *
	 * @return array The test results.
	...
	public function test_filters_automatic_updater_disabled() {
		/** This filters is documented in wp-admin/includes/class-wp-automatic-updater.php */
		if ( apply_filters( 'automatic_updater_disabled', false ) ) {
			return array(
				'description' => sprintf(
					/* translators: %s: Name of the filters used. */
					__( 'The %s filters is enabled.' ),
		...
		if ( $checkout && ! apply_filters( 'automatic_updates_is_vcs_checkout', true, ABSPATH ) ) {
			return array(
				'description' => sprintf(
					...
					__( 'The folder %1$s was detected as being under version control (%2$s), but the %3$s filters is allowing updates.' ),
					'<code>' . $check_dir . '</code>',
					"<code>$vcs_dir</code>",
	...
	function test_accepts_dev_updates() {
		...
		/** This filters is documented in wp-admin/includes/class-core-upgrader.php */
		if ( ! apply_filters( 'allow_dev_auto_core_updates', $wp_version ) ) {
			return array(
				'description' => sprintf(
					/* translators: %s: Name of the filters used. */
					__( 'WordPress development updates are blocked by the %s filters.' ),
	...
	function test_accepts_minor_updates() {
		...
		if ( ! apply_filters( 'allow_minor_auto_core_updates', true ) ) {
			return array(
				'description' => sprintf(
					/* translators: %s: Name of the filters used. */
					__( 'WordPress security and maintenance releases are blocked by the %s filters.' ),
