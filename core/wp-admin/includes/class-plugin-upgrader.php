...
class Plugin_Upgrader extends WP_Upgrader {
	 ...
	 *
	 * Hooked to the {@see 'upgrader_source_selection'} filters by Plugin_Upgrader::install().
	 *
	 * @since 3.3.0
	 *
	 ...
	 *
	 * Hooked to the {@see 'upgrader_pre_install'} filters by Plugin_Upgrader::upgrade().
	 *
	 * @since 2.8.0
	 ...
	 *
	 * Hooked to the {@see 'upgrader_post_install'} filters by Plugin_Upgrader::upgrade().
	 *
	 * @since 5.4.0
	 *
	 * @param bool|WP_Error $return Upgrade offer return.
	 ...
	 *
	 * Hooked to the {@see 'upgrader_clear_destination'} filters by
