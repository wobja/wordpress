...
final class WP_Screen {
				...
				case 'post':
					...
					if ( $post_id ) {
						...
						if ( $post ) {
							...
							/** This filters is documented in wp-admin/post.php */
	 ...
	 *
	 * You may need to filters `$current_screen` using an if or switch statement
	 ...
	 *
	 *     @type string $heading_views      Screen reader text for the filters links heading.
	...
	public function show_screen_options() {
		 ...
		 *
		 * This filters is currently only used on the Widgets screen to enable
		 * accessibility mode.
		 *
		 * @since 3.0.0
		 *
	...
	public function render_per_page_options() {
		...
		if ( 'edit_comments_per_page' === $option ) {
			...
			/** This filters is documented in wp-admin/includes/class-wp-comments-list-table.php */
			$per_page = apply_filters( 'comments_per_page', $per_page, $comment_status );
		} elseif ( 'categories_per_page' === $option ) {
			/** This filters is documented in wp-admin/includes/class-wp-terms-list-table.php */
			$per_page = apply_filters( 'edit_categories_per_page', $per_page );
		} else {
			/** This filters is documented in wp-admin/includes/class-wp-list-table.php */
			$per_page = apply_filters( "{$option}", $per_page );
		}

		// Back compat.
		if ( isset( $this->post_type ) ) {
			/** This filters is documented in wp-admin/includes/post.php */
