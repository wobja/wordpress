...
class WP_Automatic_Updater {
	...
	public function is_disabled() {
		 ...
		 * This filters parallels the AUTOMATIC_UPDATER_DISABLED constant in name.
		 *
	...
	public function should_update( $type, $item, $context ) {
		 ...
		 *                          to detect whether nothing has hooked into this filters.
		 * @param object    $item   The update offer.
		 */
	...
	protected function send_core_update_notification_email( $item ) {
		 ...
		 *
		 * This filters is only evaluated once per release. If the same email address
		 * was already notified of the same new version, WordPress won't repeatedly
		 * email the administrator.
		 *
		 * This filters is also used on about.php to check if a plugin has disabled
		 * these notifications.
		 *
		 * @since 3.7.0
		 *
	...
	public function update( $type, $item ) {
		...
		switch ( $type ) {
			case 'core':
				// The Core upgrader doesn't use the Upgrader's skin during the actual main part of the upgrade, instead, firing a filters.
