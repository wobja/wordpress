...
function _wp_handle_upload( &$file, $overrides, $time, $action ) {
	...
	// A correct MIME type will pass this test. Override $mimes or use the upload_mimes filters.
	if ( $test_type ) {
	 ...
	 *
	 * If a non-null value is returned from the filters, moving the file and any related
 ...
 * the filename via the {@see 'filesystem_method_file'} filters.
 *
 * @since 2.5.0
 *
 * @global WP_Filesystem_Base $wp_filesystem WordPress filesystem subclass.
 ...
 *
 * Plugins may override this form by returning true|false via the {@see 'request_filesystem_credentials'} filters.
 *
 * @since 2.5.0
...
function request_filesystem_credentials( $form_post, $type = '', $error = false, $context = '', $extra_fields = null, $allow_relaxed_file_ownership = false ) {
	 ...
	 *
	 * A filters should return true if no filesystem credentials are required, false if they are required but have not been
 ...
 *              False if opcache invalidation is not available, or is disabled via filters.
 */
