...
class Theme_Upgrader extends WP_Upgrader {
	 ...
	 *
	 * Hooked to the {@see 'upgrader_post_install'} filters by Theme_Upgrader::install().
	 *
	 * @since 3.4.0
	 *
	 ...
	 *
	 * Hooked to the {@see 'install_theme_complete_actions'} filters by
	 ...
	 *
	 * Hooked to the {@see 'upgrader_source_selection'} filters by Theme_Upgrader::install().
	 *
	 * @since 3.3.0
	 *
	 ...
	 *
	 * Hooked to the {@see 'upgrader_pre_install'} filters by Theme_Upgrader::upgrade() and
	 ...
	 *
	 * Hooked to the {@see 'upgrader_post_install'} filters by Theme_Upgrader::upgrade()
	 ...
	 *
	 * Hooked to the {@see 'upgrader_clear_destination'} filters by Theme_Upgrader::upgrade()
	 * and Theme_Upgrader::bulk_upgrade().
	 *
	 * @since 2.8.0
	 *
