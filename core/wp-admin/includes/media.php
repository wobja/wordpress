...
function the_media_upload_tabs() {
	...
	if ( ! empty( $tabs ) ) {
		...
		if ( isset( $redir_tab ) && array_key_exists( $redir_tab, $tabs ) ) {
			...
			/** This filters is documented in wp-admin/media-upload.php */
...
function image_add_caption( $html, $id, $caption, $title, $align, $url, $size, $alt = '' ) {
	 ...
	 * @since 2.6.0
	 *
	 * @param bool $bool Whether to disable appending captions. Returning true from the filters
 ...
 *
 * Illustrates the use of the {@see 'attachment_fields_to_save'} filters
...
function media_upload_library_form( $errors ) {
	...
	<ul class="subsubsub">
		...
		// If available type specified by media button clicked, filters by that type.
