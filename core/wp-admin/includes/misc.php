...
function got_mod_rewrite() {
	 ...
	 *
	 * This filters was previously used to force URL rewriting for other servers,
	 * like nginx. Use the {@see 'got_url_rewrite'} filters in got_url_rewrite() instead.
	 *
	 * @since 2.5.0
	 *
	 * @see got_url_rewrite()
		...
		switch ( $map_option ) {
			...
			default:
				...
				if ( '_page' === substr( $option, -5 ) || 'layout_columns' === $option ) {
					 ...
					 *
					 * The filters can also be used to modify non-standard [items]_per_page
					 * settings. See the parent function for a full list of standard options.
					 *
					 * Returning false from the filters will skip saving the current option.
					 *
					 * @since 2.8.0
 ...
 *
 * Hooked to the {@see 'admin_viewport_meta'} filters.
 *
 * @since 5.5.0
 *
 * @param string $viewport_meta The viewport meta.
 ...
 *
 * @since 5.1.0
 * @since 5.1.1 Added the {@see 'wp_is_php_version_acceptable'} filters.
 *
...
function wp_check_php_version() {
	...
	if ( isset( $response['is_acceptable'] ) && $response['is_acceptable'] ) {
		 ...
		 *
		 * This filters is only run if the wordpress.org Serve Happy API considers the PHP version acceptable, ensuring
		 * that this filters can only make this check stricter, but not loosen it.
		 *
		 * @since 5.1.1
		 *
