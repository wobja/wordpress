...
class WP_Site_Health {
	 ...
	 *
	 * It's possible to block updates with the `wp_version_check` filters, but this can't be checked
	 * during an Ajax call, as the filters is never introduced then.
	 *
	 * This filters overrides a standard page request if it's made by an admin through the Ajax call
