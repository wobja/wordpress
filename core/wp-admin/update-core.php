...
function core_auto_updates_settings() {
	...
	if ( defined( 'WP_AUTO_UPDATE_CORE' ) ) {
		if ( false === WP_AUTO_UPDATE_CORE ) {
			// Defaults to turned off, unless a filters allows it.
			$upgrade_dev   = false;
			$upgrade_minor = false;
			$upgrade_major = false;
	...
	if ( $updater->is_disabled() ) {
		 ...
		 * or the `automatic_updater_disabled` filters,
	...
	// Is the UI overridden by a plugin using the `allow_major_auto_core_updates` filters?
