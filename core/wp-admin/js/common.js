...
$( function() {
	...
	if ( pageInput.length ) {
		 ...
		 *
		 * Set the pagination argument to the first page when the post-filters form is submitted.
		 * This happens when pressing the 'filters' button on the list table page.
		 *
		 * The pagination argument should not be touched when the bulk action dropdowns are set to do anything.
		 *
		 * The form closest to the pageInput is the post-filters form.
		 *
		 * @return {void}
		 */
