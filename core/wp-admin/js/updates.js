...
(function( $, wp, settings ) {
	...
	wp.updates.refreshCount = function() {
		...
		// Update list table filters navigation.
	...
	$( function() {
		var $pluginFilter        = $( '#plugin-filters' ),
			$bulkActionForm      = $( '#bulk-action-form' ),
			$filesystemForm      = $( '#request-filesystem-credentials-form' ),
			$filesystemModal     = $( '#request-filesystem-credentials-dialog' ),
			$pluginSearch        = $( '.plugins-php .wp-filters-search' ),
			$pluginInstallSearch = $( '.plugin-install-php .wp-filters-search' );
		...
		$pluginInstallSearch.on( 'keyup input', _.debounce( function( event, eventtype ) {
			...
			if ( ! $searchTab.length ) {
				...
				$( '.wp-filters .filters-links .current' )
					.removeClass( 'current' )
					.parents( '.filters-links' )
					.prepend( $searchTab );
