...
function validate_another_blog_signup() {
	 ...
	 *
	 * Use the {@see 'add_signup_meta'} filters instead.
	 *
	 * @since MU (3.0.0)
	 * @deprecated 3.0.0 Use the {@see 'add_signup_meta'} filters instead.
	 *
 ...
 * @param array  $meta       Any additional meta from the {@see 'add_signup_meta'} filters in validate_blog_signup().
...
function validate_user_signup() {
	...
	/** This filters is documented in wp-signup.php */
...
function signup_get_available_languages() {
	 ...
	 * in a callback hooked to the 'signup_get_available_languages' filters before this point.
	 */
